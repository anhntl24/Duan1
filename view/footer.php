...
<script>
    ...
    function confirmOrder() {
        return confirm("Bạn có chọn thanh toán khi nhận hàng ?");
    };

    function confirmdelete() {
        return confirm("Bạn có chắc muốn xóa không ?");
    };
    function confirmdeupdate() {
        return confirm("Bạn có chắc muốn thay đổi thông tin đặt hàng ?");
    };
</script>