            ...
            <div class="col-12">
                <nav class="main-nav">
                    ...
                    <ul class="nav" style="margin-top:4%">
                        ...
                        <li class="scroll-to-section"><a href="?act=gioithieu">Giới thiệu</a></li>
                        <li class="scroll-to-section"><a href="?act=lienhe">Liên hệ</a></li>
                        ...
                        <li>
                            <form action="index.php?act=sanpham" method="POST">
                                <div style="border:none;border-bottom:1px solid #ccc; margin-left:20px;">
                                    <input type="text" name=kyw style="border: none; " placeholder="Tìm kiếm">
                        ...
                        ?>
                            <li class="submenu">
                                ...
                                <ul>
                                    <li><a href="index.php?act=changepasswordtc">Đổi mật khẩu</a></li>
                                    <li><a href="index.php?act=capnhattaikhoan">Cập nhật tài khoản</a></li>
                                    <li><a href="index.php?act=mycart">Đơn hàng của tôi</a></li>
                                    <?php if ($role == 1) { ?>
